    ...
    <div class="p-6">
        <div class="mb-6">
            <div class="flex items-center gap-2 mb-2">
                ...
                <h1 class="text-3xl font-bold text-surface-900 dark:text-surface-0">Create User</h1>
            </div>
            <p class="text-surface-600 dark:text-surface-400">Add a new user to the system</p>
        </div>
            ...
            <form @submit.prevent="submitForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <Password id="password" v-model="form.password" placeholder="Enter password" :feedback="true"
                            toggleMask :invalid="!!errors.password" />
                        <small v-if="errors.password" class="text-red-500">{{ errors.password }}</small>
                        <small class="text-surface-500">Minimum 8 characters</small>
                    </div>
                ...
                <div class="flex justify-end gap-3 mt-6 pt-6 border-t border-surface-200 dark:border-surface-800">
                    ...
                    <Button label="Create User" icon="pi pi-check" type="submit" :loading="loading" />
                </div>
            </form>
        </div>
    </div>
