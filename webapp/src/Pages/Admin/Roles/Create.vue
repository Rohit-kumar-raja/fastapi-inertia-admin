    ...
    <div class="p-6">
        <div class="mb-6">
            <div class="flex items-center gap-2 mb-2">
                ...
                <h1 class="text-3xl font-bold text-surface-900 dark:text-surface-0">Create Role</h1>
            </div>
            <p class="text-surface-600 dark:text-surface-400">Add a new role with permissions</p>
        </div>
        ...
        <div
            ...
            <form @submit.prevent="submitForm">
                ...
                <div class="flex justify-end gap-3 pt-6 border-t border-surface-200 dark:border-surface-800">
                    ...
                    <Button label="Create Role" icon="pi pi-check" type="submit" :loading="loading" />
                </div>
            </form>
        </div>
    </div>
